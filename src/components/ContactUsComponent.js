    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <div className="row row-content row-container">
                    <div className="col-12">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="mailto:noskype@gmail.com"><i className="fa fa-skype"></i> Skype</a>
                ...
                <div className="row row-container row-content">
                    <div className="col-12">
                        <h3>Send Us Your Feedback</h3>
                    </div>
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit= {(values) => {this.handleSubmit(values)}} autoComplete="off">
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                                  ...
                                                  className="form-control"
                                                  validators={{required,minlength:minlength(3),maxlength:maxlength(15) ,isNumber:isNumber}}
                                    />
                                    <Errors model=".telnum" className="text-danger" show="touched" messages={{
                                        required:"required",
                                        minlength : "minlength must be 3 digits",
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" id="email" name="email"
                                                  placeholder="Email"
                                                  className="form-control"
                                                  validators={{required,minlength:minlength(3),maxlength:maxlength(40),validEmail}}
                                    />
                                    <Errors model=".email" className="text-danger" show="touched" messages={{
                                        required:"required",
                                        minlength : "minlength must be 3 char",
                                        maxlength : "maxlength must be 40",
